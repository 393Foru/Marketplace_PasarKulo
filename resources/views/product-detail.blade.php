...
<div class="container py-3">
    ...
    <div class="row g-4">
        <div class="col-md-4 col-lg-5">
            <div class="card border-0 shadow-sm p-2 mb-3 d-flex align-items-center justify-content-center bg-light" style="height: 400px;">
                ...
                <div class="d-flex gap-2 mt-2 overflow-auto">
                    ...
                    @for($i=0; $i<4; $i++)
                        <img src="{{ asset('img/products/' . $product->image) }}"
                        class="rounded border {{ $i == 0 ? 'border-primary' : '' }}"
                        style="width: 70px; height: 70px; object-fit: cover; cursor: pointer; opacity: {{ $i == 0 ? '1' : '0.8' }};"
                        onmouseover="this.style.opacity=1"
                        onmouseout="this.style.opacity={{ $i == 0 ? '1' : '0.8' }}"
                        alt="{{ $product->name }}">
                        @endfor
